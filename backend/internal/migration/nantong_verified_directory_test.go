...
func TestNantongVerifiedDiningSeed(t *testing.T) {
	spec := nantongVerifiedDiningSpec
	spec.SeedPath = "../../data/nantong_verified_dining_seed_20260818.json"
