...
func TestDalianVerifiedDiningSeed(t *testing.T) {
	spec := dalianVerifiedDiningSpec
	spec.SeedPath = "../../data/dalian_verified_dining_seed_20260816.json"
	...
	assert.Equal(t, 9, totalFloorRelations)
