...
func TestBaodingVerifiedDiningSeed(t *testing.T) {
	spec := baodingVerifiedDiningSpec
	spec.SeedPath = "../../data/baoding_verified_dining_seed_20260816.json"
	...
	assert.Equal(t, 5, totalCanteens)
}
