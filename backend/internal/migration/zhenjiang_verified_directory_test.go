...
func TestZhenjiangVerifiedDiningSeed(t *testing.T) {
	spec := zhenjiangVerifiedDiningSpec
	spec.SeedPath = "../../data/zhenjiang_verified_dining_seed_20260818.json"
	...
	assert.Equal(t, 18, totalFloorRelations)
