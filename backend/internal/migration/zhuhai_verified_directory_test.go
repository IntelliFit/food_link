...
func TestZhuhaiVerifiedDiningSeed(t *testing.T) {
	spec := zhuhaiVerifiedDiningSpec
	spec.SeedPath = "../../data/zhuhai_verified_dining_seed_20260818.json"
	...
	assert.Equal(t, 8, totalFloorRelations)
