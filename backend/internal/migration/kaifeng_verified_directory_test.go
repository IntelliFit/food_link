...
func TestKaifengVerifiedDiningSeed(t *testing.T) {
	spec := kaifengVerifiedDiningSpec
	spec.SeedPath = "../../data/kaifeng_verified_dining_seed_20260816.json"
