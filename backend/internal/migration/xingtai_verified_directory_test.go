...
func TestXingtaiVerifiedDiningSeed(t *testing.T) {
	spec := xingtaiVerifiedDiningSpec
	spec.SeedPath = "../../data/xingtai_verified_dining_seed_20260818.json"
	...
	assert.Equal(t, 3, totalFloorRelations)
