...
func TestZhangjiajieVerifiedDiningSeed(t *testing.T) {
	spec := zhangjiajieVerifiedDiningSpec
	spec.SeedPath = "../../data/zhangjiajie_verified_dining_seed_20260820.json"
	...
	assert.Equal(t, 2, totalFloorRelations)
