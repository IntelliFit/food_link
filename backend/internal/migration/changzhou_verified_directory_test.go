...
func TestChangzhouVerifiedDiningSeed(t *testing.T) {
	spec := changzhouVerifiedDiningSpec
	spec.SeedPath = "../../data/changzhou_verified_dining_seed_20260816.json"
	...
	assert.Equal(t, 15, totalCanteens)
	assert.Equal(t, 34, totalFloorRelations)
}
