...
func ensureConstraints(ctx context.Context, db *gorm.DB) error {
	for _, sql := range []string{
		...
		dropAndAddCheck("analysis_tasks", "analysis_tasks_task_type_check", `task_type = ANY (ARRAY['food'::text,'food_text'::text,'precision_plan'::text,'precision_item_estimate'::text,'precision_aggregate'::text,'health_report'::text,'public_food_library_text'::text,'exercise'::text,'custom_focus'::text,'expiry_recognize'::text,'expiry_notification'::text,'packaged_nutrition_label'::text,'packaged_product_extract'::text]) OR task_type ~ '^(food|food_text|precision_plan|precision_item_estimate|precision_aggregate|health_report|public_food_library_text|exercise|custom_focus|expiry_recognize|expiry_notification|packaged_nutrition_label|packaged_product_extract)_debug(_[a-z0-9_]+)?$'`),
		...
		dropAndAddCheck("open_api_apps", "open_api_apps_status_check", `status = ANY (ARRAY['active'::text,'disabled'::text])`),
		dropAndAddCheck("open_api_apps", "open_api_apps_balance_units_check", `balance_units >= 0`),
		dropAndAddCheck("open_api_keys", "open_api_keys_status_check", `status = ANY (ARRAY['active'::text,'revoked'::text])`),
		dropAndAddCheck("open_api_requests", "open_api_requests_status_check", `status = ANY (ARRAY['reserved'::text,'submitted'::text,'refunded'::text,'failed'::text])`),
		dropAndAddCheck("open_api_requests", "open_api_requests_cost_units_check", `cost_units > 0`),
		dropAndAddCheck("open_api_usage_ledger", "open_api_usage_ledger_delta_units_check", `delta_units <> 0`),
		dropAndAddCheck("open_api_credit_packages", "open_api_credit_packages_units_check", `units > 0`),
		dropAndAddCheck("open_api_credit_packages", "open_api_credit_packages_amount_fen_check", `amount_fen > 0`),
		dropAndAddCheck("open_api_payment_orders", "open_api_payment_orders_status_check", `status = ANY (ARRAY['pending'::text,'paid'::text,'failed'::text,'closed'::text])`),
		dropAndAddCheck("open_api_payment_orders", "open_api_payment_orders_units_check", `units > 0`),
		dropAndAddCheck("open_api_payment_orders", "open_api_payment_orders_amount_fen_check", `amount_fen > 0`),
		...
		addFK("open_api_apps_service_user_id_fkey", "open_api_apps", "service_user_id", "weapp_user", "id", "CASCADE"),
		addFK("open_api_apps_owner_user_id_fkey", "open_api_apps", "owner_user_id", "weapp_user", "id", "SET NULL"),
		addFK("open_api_keys_app_id_fkey", "open_api_keys", "app_id", "open_api_apps", "id", "CASCADE"),
		addFK("open_api_requests_app_id_fkey", "open_api_requests", "app_id", "open_api_apps", "id", "CASCADE"),
		addFK("open_api_requests_task_id_fkey", "open_api_requests", "task_id", "analysis_tasks", "id", "SET NULL"),
		addFK("open_api_usage_ledger_app_id_fkey", "open_api_usage_ledger", "app_id", "open_api_apps", "id", "CASCADE"),
		addFK("open_api_usage_ledger_request_id_fkey", "open_api_usage_ledger", "request_id", "open_api_requests", "id", "SET NULL"),
		addFK("open_api_payment_orders_owner_user_id_fkey", "open_api_payment_orders", "owner_user_id", "weapp_user", "id", "CASCADE"),
