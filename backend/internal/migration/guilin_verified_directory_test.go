...
func TestGuilinVerifiedDiningSeed(t *testing.T) {
	spec := guilinVerifiedDiningSpec
	spec.SeedPath = "../../data/guilin_verified_dining_seed_20260816.json"
	...
	assert.Equal(t, 9, totalCanteens)
}
