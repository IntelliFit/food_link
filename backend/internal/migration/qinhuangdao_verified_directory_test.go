...
func TestQinhuangdaoVerifiedDiningSeed(t *testing.T) {
	spec := qinhuangdaoVerifiedDiningSpec
	spec.SeedPath = "../../data/qinhuangdao_verified_dining_seed_20260818.json"
