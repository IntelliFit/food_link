...
COMMENT ON TABLE public.feed_interaction_notifications IS '圈子互动通知：收到评论、收到回复、评论审核未通过';
...
COMMENT ON COLUMN public.feed_interaction_notifications.notification_type IS 'comment_received / reply_received / comment_rejected';
