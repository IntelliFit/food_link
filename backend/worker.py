...
def _build_result_items_with_lookup(task: Dict[str, Any], parsed_items: Any) -> list:
    ...
    for raw_item in source_items:
        ...
        unit = resolve.get("unit_nutrition_per_100g") or {
            "calories": 0,
            "protein": 0,
            "carbs": 0,
            "fat": 0,
        ...
        out.append({
            ...
            "unit_nutrition_per_100g": {
                ...
                "fiber": float(unit.get("fiber") or 0),
                "sugar": float(unit.get("sugar") or 0),
                "saturatedFat": float(unit.get("saturatedFat") or 0),
                "cholesterolMg": float(unit.get("cholesterolMg") or 0),
                "sodiumMg": float(unit.get("sodiumMg") or 0),
                "potassiumMg": float(unit.get("potassiumMg") or 0),
                "calciumMg": float(unit.get("calciumMg") or 0),
                "ironMg": float(unit.get("ironMg") or 0),
                "magnesiumMg": float(unit.get("magnesiumMg") or 0),
                "zincMg": float(unit.get("zincMg") or 0),
                "vitaminARaeMcg": float(unit.get("vitaminARaeMcg") or 0),
                "vitaminCMg": float(unit.get("vitaminCMg") or 0),
                "vitaminDMcg": float(unit.get("vitaminDMcg") or 0),
                "vitaminEMg": float(unit.get("vitaminEMg") or 0),
                "vitaminKMcg": float(unit.get("vitaminKMcg") or 0),
                "thiaminMg": float(unit.get("thiaminMg") or 0),
                "riboflavinMg": float(unit.get("riboflavinMg") or 0),
                "niacinMg": float(unit.get("niacinMg") or 0),
                "vitaminB6Mg": float(unit.get("vitaminB6Mg") or 0),
                "folateMcg": float(unit.get("folateMcg") or 0),
                "vitaminB12Mcg": float(unit.get("vitaminB12Mcg") or 0),
            },
            "nutrients": {
                ...
                "fiber": round(float(unit.get("fiber") or 0) * factor, 2),
                "sugar": round(float(unit.get("sugar") or 0) * factor, 2),
                "saturatedFat": round(float(unit.get("saturatedFat") or 0) * factor, 2),
                "cholesterolMg": round(float(unit.get("cholesterolMg") or 0) * factor, 2),
                "sodiumMg": round(float(unit.get("sodiumMg") or 0) * factor, 2),
                "potassiumMg": round(float(unit.get("potassiumMg") or 0) * factor, 2),
                "calciumMg": round(float(unit.get("calciumMg") or 0) * factor, 2),
                "ironMg": round(float(unit.get("ironMg") or 0) * factor, 2),
                "magnesiumMg": round(float(unit.get("magnesiumMg") or 0) * factor, 2),
                "zincMg": round(float(unit.get("zincMg") or 0) * factor, 2),
                "vitaminARaeMcg": round(float(unit.get("vitaminARaeMcg") or 0) * factor, 2),
                "vitaminCMg": round(float(unit.get("vitaminCMg") or 0) * factor, 2),
                "vitaminDMcg": round(float(unit.get("vitaminDMcg") or 0) * factor, 2),
                "vitaminEMg": round(float(unit.get("vitaminEMg") or 0) * factor, 2),
                "vitaminKMcg": round(float(unit.get("vitaminKMcg") or 0) * factor, 2),
                "thiaminMg": round(float(unit.get("thiaminMg") or 0) * factor, 2),
                "riboflavinMg": round(float(unit.get("riboflavinMg") or 0) * factor, 2),
                "niacinMg": round(float(unit.get("niacinMg") or 0) * factor, 2),
                "vitaminB6Mg": round(float(unit.get("vitaminB6Mg") or 0) * factor, 2),
                "folateMcg": round(float(unit.get("folateMcg") or 0) * factor, 2),
                "vitaminB12Mcg": round(float(unit.get("vitaminB12Mcg") or 0) * factor, 2),
            },
        })
    return out
