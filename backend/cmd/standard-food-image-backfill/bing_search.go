...
// Bing 图片搜索实现与历史 Python 爬虫一致：
// GET https://cn.bing.com/images/search?q=…&first=…
// 遍历 .iusc 的 href，取 mediaurl（原图 URL）作为候选。
...
// parseBingIuscFromSearchHTML 按文档顺序解析每个 class="iusc" 锚点。
...
// bingMediaURLFromHref 对应 Python: decode_href.split('&')[4][9:]
