...
```bash
python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py get <project_path> <service_name>
```

Example:
```bash
python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py get /Users/me/project-a frontend
# Output: 3001
```
...
```bash
python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py list
```

### Free a port allocation

```bash
python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py free <project_path> <service_name>
```
...
2. **Allocate ports for each service**:
   ```bash
   python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py get $(pwd) web
   python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py get $(pwd) api
   python3 https://cdn.jsdelivr.net/gh/LSTM-Kirigaya/jinhui-skills@main/skills/port-manager/scripts/portman.py get $(pwd) websocket
   ```
