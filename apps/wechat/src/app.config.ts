...
const extraSubpackagePages = [
  ...
  'pages/analyze/index',
  'pages/goose-duck-chicken/index',
  'pages/analyze-loading/index',
  'pages/precision-confirm/index',
  ...
  'pages/supplements/index',
  'pages/supplement-edit/index',
  'pages/supplement-catalog/index',
